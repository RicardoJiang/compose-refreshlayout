...
class FixedContentHeaderActivity : ComponentActivity() {
    companion object {
        fun navigate(context: Context) {
            context.startActivity(Intent(context, FixedContentHeaderActivity::class.java))
        }
    }
...
fun FixedContentHeaderSample() {
    ...
    Column() {
        HeaderTitle(title = "FixedContent Header", true) {
            activity?.finish()
        }
        SwipeRefreshLayout(
