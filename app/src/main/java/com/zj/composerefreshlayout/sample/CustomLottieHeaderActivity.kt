...
import com.zj.composerefreshlayout.customheader.LottieHeaderOne
...
class CustomLottieHeaderActivity : ComponentActivity() {
    companion object {
        fun navigate(context: Context) {
            context.startActivity(Intent(context, CustomLottieHeaderActivity::class.java))
        }
    }
...
fun CustomLottieHeaderSample() {
    ...
    Column() {
        HeaderTitle(title = "自定义Lottie Header", true) {
            activity?.finish()
        }
        SwipeRefreshLayout(
